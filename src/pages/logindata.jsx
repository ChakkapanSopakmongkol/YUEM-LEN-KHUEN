            ...
            <div className="absolute top-1/2 left-1/2 w-[1000px] h-[550px] bg-white z-50 -translate-x-1/2 -translate-y-1/2 flex rounded-3xl">
                ...
                <div className="z-10 text-[36px] font-bold ml-120 mt-20">
                    ...
                    <div className="text-[12px] font-normal -ml-5">
                        <h1>โปรดกรอกข้อมูลให้ครบถ้วนเพื่อเข้าสู่ระบบ</h1>
                    </div>
                    <div className="text-[12px] font-normal -ml-30 mt-3">
                        ...
                        <div className="mt-5">
                            ...
                            <div className="flex mt-0">    
                                ...
                                <Link to="/Forgetpass">
                                    <div className="mt-5 ml-65 text-[#62C538]">                   
                                        <p>ลืมรหัสผ่าน</p>   
                                    </div>
                                </Link>
                            </div>
                    ...
                    <div className="flex gap-2 text-[12px] ml-6 mt-2">
                        <div>
                            <p className="font-normal">คุณไม่มีบัญชี?</p>
                        </div>
                        
                        <div>
                            <Link to="/Member">
                            <p className="font-normal text-[#62C538]">ลงทะเบียน</p>
                            </Link>
                        </div>
                    </div>
